...
- [PatchTST-FM](api/models/foundation/models.md#foundationforecast.models.patchtst_fm.PatchTSTFM) ([arXiv:2602.06909](https://arxiv.org/abs/2602.06909)) — Python 3.11–3.13; [`ibm-research/patchtst-fm-r1`](https://huggingface.co/ibm-research/patchtst-fm-r1), [`ibm-granite/granite-timeseries-patchtst-fm-r1`](https://huggingface.co/ibm-granite/granite-timeseries-patchtst-fm-r1) (CC-BY-NC-SA-4.0), and [`ibm-granite/granite-timeseries-patchtst-fm-r2`](https://huggingface.co/ibm-granite/granite-timeseries-patchtst-fm-r2) (Apache-2.0 / OpenMDW 1.0; requires `granite-tsfm>=0.3.9`)
...
- [T0](api/models/foundation/models.md#foundationforecast.models.t0.T0) ([t0-alpha](https://huggingface.co/theforecastingcompany/t0-alpha), [t0-beta](https://huggingface.co/theforecastingcompany/t0-beta); requires `tfc-t0>=0.5.0` for beta) — Python 3.11–3.13
